...
public class Day01Test  {
	...
	@Test
	public void part1() {
		String answer = day.part1("src/test/resources/01.txt");
	...
	@Test
	public void part2() {
		String answer = day.part2("src/test/resources/01.txt");
		System.out.println(String.format("%s.2: %s", day.getClass().getSimpleName(), answer));
		Assert.assertEquals("", day.part2("src/test/resources/01-3.txt"));
	}
}
